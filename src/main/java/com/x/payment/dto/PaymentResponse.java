...
public record PaymentResponse(
        Long id, Long orderId, Long businessId, Long storeId, Long cashierId, BigDecimal amount,
    ...
    public static PaymentResponse from(Payment payment) {
        return new PaymentResponse(
                payment.getId(), payment.getOrderId(), payment.getBusinessId(), payment.getStoreId(), payment.getCashierId(),
